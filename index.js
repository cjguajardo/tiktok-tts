...
async function createAudioFromText(
  ...
  if (text === null)
    throw new Error('You must provide a text to convert to audio');
...
module.exports = {
  config: function (tiktokSessionId, customBaseUrl) {
    return config(tiktokSessionId, customBaseUrl);
  },
